...
if { conda env list | grep 'providentia-env_v3.0.0-nord4'; } >/dev/null 2>&1; then 
    echo "Activating conda environment in /gpfs/projects/bsc32/repository/apps/conda_envs/providentia-env_v3.0.0-nord4..."
    conda activate providentia-env_v3.0.0-nord4
else 
