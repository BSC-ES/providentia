...
The calibration factor can be used to modify the data of your models. To use it, users need to set the `calibration_factor` in the configuration file, as in:
...
The calibration factor could also be defined for diferent models in this way:
```
calibration_factor = a54s-regional-000 (*0.62), a4xf-regional-000 (*0.51)
```

Using diferent species, we would need to add the factors to the list of each model:
```
