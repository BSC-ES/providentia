...
> If you already have an ECMWF account, you can skip this subsection and go to [Prepare the Configuration File](#prepare-the-configuration-file).  
...
Before downloading, prepare your configuration file.  It’s recommended to first read **[How to Enable Atmosphere Data Store Download](#how-to-enable-atmosphere-data-store-download)**.  
