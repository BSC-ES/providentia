...
root_grp = Dataset(compress_netCDF_fname, 'w', format="NETCDF4") 
...
for ii, station_reference in enumerate(obs_station_references):
    ...
    if ii == 0:
        ...
        model_centre_longitude_var = root_grp.createVariable('model_centre_longitude', 'f8', ('model_centre_latitude','model_centre_longitude'), chunksizes=[y_N,x_N])
        ...
        model_centre_latitude_var = root_grp.createVariable('model_centre_latitude', 'f8', ('model_centre_latitude','model_centre_longitude'), chunksizes=[y_N,x_N])
...
print('DONE:{}'.format(interpolation_time))