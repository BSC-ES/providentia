...
#Marenustrum4
    ...
    module load bsc/1.0 gcc/5.4.0 intel/2017.4 impi/2017.4 mkl/2017.4 python/3.7.4_ES udunits/2.2.25 hdf5/1.10.5 netcdf/4.4.1.1 geos/3.6.1 proj/4.9.3 gdal/2.2.3 gsl/2.4 greasy/latest nco/4.6.7
fi
