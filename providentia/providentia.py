...
class GenerateProvidentiaDashboard(QtWidgets.QWidget):
    ...
    def init_ui(self):
        ...
        self.standard_data_flag_codes = \
            json.load(open('./conf/standard_data_flag_codes.json'))
        ...
        #define qa flags
        self.standard_qa_flag_codes = json.load(open('./conf/standard_qa_flag_codes.json'))
        ...
        self.standard_classification_flag_code = \
            json.load(open('./conf/standard_classification_flag_codes.json'))
