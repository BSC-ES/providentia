def get_characteristics_per_plot_type(self):
    ...
    characteristics_per_plot_type = {
        'timeseries': {'summary_pages':[], 'station_pages':[], 'figure': {'figsize': self.landscape_figsize, 'ncols': 2, 'nrows': 3},
                       ...
                       'xticks': {'labelsize': 7, 'rotation': 0, 'n_slices': 6}, 'yticks': {'labelsize': 7},
        ...
        'distribution': {'summary_pages':[], 'station_pages':[], 'figure': {'figsize': self.portrait_figsize, 'ncols': 2, 'nrows': 4},
                         ...
                         'yticks': {'labelsize': 7}, 'legend': {'loc': 'upper right', 'ncol': 2, 'fontsize': 8.0},
                         'tightlayout': True, 'subplots_adjust': {'top': 0.90},
                         'bias_title': {'t': 'Distribution bias', 'fontsize': 15, 'ha': 'left', 'x': 0.05, 'y': 0.98},
        ...
        'periodic-violin': {'summary_pages':[], 'station_pages':[],
                            ...
                            'page_title': {'t': 'Violin plot', 'fontsize': 15, 'ha': 'left', 'x': 0.05, 'y': 0.98},
                            'axis_title': {'label': '', 'fontsize': 8},
                            ...
                            'bias_title': {'t': 'Periodic violin plot bias', 'fontsize': 15, 'ha': 'left', 'x': 0.05, 'y': 0.98},
                            'annotate_stats': ['Min', 'Max'],
                            'annotate_text': {'s': '', 'loc': 'upper right', 'fontsize': 6, 'n_stations': False},
                            'annotate_bbox': {'facecolor': 'white', 'edgecolor': 'gainsboro', 'alpha': 1}},    
        ...
        'scatter': {'summary_pages':[], 'station_pages':[],'figure': {'figsize': self.portrait_figsize, 'ncols': 2, 'nrows': 3},
                    ...
                    'legend': {'loc': 'upper right', 'ncol': 2, 'fontsize': 8.0}, 
