...
class UnitConverter:
    ...
    def load_dictionaries(self):
        ...
        self.conversion_formulae = {
                                    ...
                                    'mass_concentration>mass_fraction--conversion_factor':                       ["((molar_gas_constant*temperature)/(pressure*molar_mass_dry_air))"],
                                    ...
                                    'mass_concentration>number_density--conversion_factor':                      ["avogadro_constant/molar_mass"],
                                    'mass_fraction>mass_concentration--conversion_factor':                       ["((pressure*molar_mass_dry_air)/(molar_gas_constant*temperature))"],
                                    'mass_fraction>molarity--conversion_factor':                                 ["((pressure*molar_mass_dry_air)/(molar_gas_constant*temperature*molar_mass))"],
                                    'mass_fraction>mole_fraction--conversion_factor':                            ["molar_mass_dry_air/molar_mass"],
                                    'mass_fraction>number_density--conversion_factor':                           ["((avogadro_constant*pressure*molar_mass_dry_air)/(molar_gas_constant*temperature*molar_mass))"],
                                    'molarity>mass_concentration--conversion_factor':                            ["molar_mass"],
                                    'molarity>mass_fraction--conversion_factor':                                 ["((molar_gas_constant*temperature*molar_mass)/(pressure*molar_mass_dry_air))"],
                                    'molarity>mole_fraction--conversion_factor':                                 ["((molar_gas_constant*temperature)/pressure)"],
                                    ...
                                    'mole_fraction>molarity--conversion_factor':                                 ["(pressure/(molar_gas_constant*temperature))"],
                                    'mole_fraction>number_density--conversion_factor':                           ["((avogadro_constant*pressure)/(molar_gas_constant*temperature))"],
                                    'number_density>mass_concentration--conversion_factor':                      ["molar_mass/avogadro_constant"],
                                    'number_density>mass_fraction--conversion_factor':                           ["((molar_gas_constant*temperature*molar_mass_dry_air)/(avogadro_constant*molar_mass*pressure))"],
                                    'number_density>molarity--conversion_factor':                                ["1./avogadro_constant"],
                                    'number_density>mole_fraction--conversion_factor':                           ["((molar_gas_constant*temperature)/(avogadro_constant*pressure))"],
