...
class UnitConverter:
    ...
    def get_quantity_representation(
        ...
        for quantity in self.SI_base_quantities:
            if (
                Counter(units)
                == Counter(self.SI_base_quantities[quantity]["base_units"])
            ) or (
                Counter(units_simplified)
                == Counter(self.SI_base_quantities[quantity]["base_units"])
            ):
        ...
        for quantity in self.SI_derived_quantities:
            if (
                Counter(units)
                == Counter(self.SI_derived_quantities[quantity]["base_units"])
            ) or (
                Counter(units_simplified)
                == Counter(self.SI_derived_quantities[quantity]["base_units"])
            ):
        ...
        for quantity in self.constants:
            if (Counter(units) == Counter(self.constants[quantity]["base_units"])) or (
                Counter(units_simplified)
                == Counter(self.constants[quantity]["base_units"])
            ):
                valid_quantities.append(quantity)
    ...
    def load_dictionaries(self):
        ...
        self.non_SI_quantities = {
            "amount of substance": {
                ...
                "mole of carbon": {
                    "factor": 1.0 / get_N_atoms(self.species, "C"),
                    "standard_units": "molC",
                    "units": ["molC", "moleC"],
                    "dependencies": ["species"],
                },
                "mole of chlorine": {
                    "factor": 1.0 / get_N_atoms(self.species, "Cl"),
                    "standard_units": "molCl",
                    "units": ["molCl", "moleCl"],
                    "dependencies": ["species"],
                },
                "mole of hydrogen": {
                    "factor": 1.0 / get_N_atoms(self.species, "H"),
                    "standard_units": "molH",
                    "units": ["molH", "moleH"],
                    "dependencies": ["species"],
                },
                "mole of nitrogen": {
                    "factor": 1.0 / get_N_atoms(self.species, "N"),
                    "standard_units": "molN",
                    "units": ["molN", "moleN"],
                    "dependencies": ["species"],
                },
                "mole of sulphur": {
                    "factor": 1.0 / get_N_atoms(self.species, "S"),
                    "standard_units": "molS",
                    "units": ["molS", "moleS"],
                    "dependencies": ["species"],
                },
            ...
            "mass": {
                ...
                "gram of carbon": {
                    "factor": 1e-3
                    * (
                        get_molecular_mass(self.species)
                        / (get_molecular_mass("C") * get_N_atoms(self.species, "C"))
                    ),
                    "standard_units": "gC",
                ...
                "gram of chlorine": {
                    ...
                    * (
                        get_molecular_mass(self.species)
                        / (get_molecular_mass("Cl") * get_N_atoms(self.species, "Cl"))
                    ),
                    "standard_units": "gCl",
                ...
                "gram of nitrogen": {
                    ...
                    * (
                        get_molecular_mass(self.species)
                        / (get_molecular_mass("N") * get_N_atoms(self.species, "N"))
                    ),
                    "standard_units": "gN",
                ...
                "gram of calcium carbonate": {
                    "factor": 1e-3
                    * (
                        (get_molecular_mass(self.species) / self.valence)
                ...
                "gram of sulphur": {
                    ...
                    * (
                        get_molecular_mass(self.species)
                        / (get_molecular_mass("S") * get_N_atoms(self.species, "S"))
                    ),
                    "standard_units": "gS",
            ...
            "mole_fraction": {
                ...
                "ppmv of carbon": {
                    "factor": 1e-6 / (get_N_atoms(self.species, "C")),
                ...
                "ppmv of chlorine": {
                    "factor": 1e-6 / (get_N_atoms(self.species, "Cl")),
                ...
                "ppmv of nitrogen": {
                    "factor": 1e-6 / (get_N_atoms(self.species, "N")),
                ...
                "ppmv of sulphur": {
                    "factor": 1e-6 / (get_N_atoms(self.species, "S")),
                ...
                "ppbv of carbon": {
                    "factor": 1e-9 / (get_N_atoms(self.species, "C")),
                ...
                "ppbv of chlorine": {
                    "factor": 1e-9 / (get_N_atoms(self.species, "Cl")),
                ...
                "ppbv of nitrogen": {
                    "factor": 1e-9 / (get_N_atoms(self.species, "N")),
                ...
                "ppbv of sulphur": {
                    "factor": 1e-9 / (get_N_atoms(self.species, "S")),
                ...
                "pptv of carbon": {
                    "factor": 1e-12 / (get_N_atoms(self.species, "C")),
                ...
                "pptv of chlorine": {
                    "factor": 1e-12 / (get_N_atoms(self.species, "Cl")),
                ...
                "pptv of nitrogen": {
                    "factor": 1e-12 / (get_N_atoms(self.species, "N")),
                ...
                "pptv of sulphur": {
                    "factor": 1e-12 / (get_N_atoms(self.species, "S")),
