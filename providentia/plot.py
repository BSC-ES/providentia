...
class Plot:
    ...
    def make_heatmap(self, relevant_axis, stats_df, plot_characteristics, networkspeci=None, subsection=None, 
                     plotting_paradigm=None, plot_options=[]):
        """ Make heatmap plot.
    ...
    def make_table(self, relevant_axis, stats_df, plot_characteristics, networkspeci=None, subsection=None, 
                   plotting_paradigm=None, plot_options=[], statsummary=False):
        """ Make table plot.
    ...
    def make_taylor(self, relevant_axis, stats_df, reference_stddev, plot_characteristics, plot_options=[]):
