...
class GenerateProvidentiaDashboard(QtWidgets.QWidget, ProvConfiguration):
    ...
    def handle_pop_up_experiments_window(self):
        # setup pop up window
        self.experiments_window = PopUpWindow(window_type='EXPERIMENTS', window_titles=['Select Experiment/s'], checkbox_labels=[self.available_experiment_grids], default_checkbox_selection=[[]], selected_indices=self.selected_indices)
