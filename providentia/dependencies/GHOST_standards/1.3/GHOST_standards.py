...
standard_parameters = {
    ...
    "CEILING_HEIGHT": {
        "long_parameter_name": "ceiling height",
        "matrix": "meteo",
        "standard_units": "m",
        "axis_label": "height",
    ...
    "CLOUD_CVG": {
        "long_parameter_name": "cloud coverage",
        "matrix": "meteo",
    ...
    "CLOUD_CVG_FRAC": {
        "long_parameter_name": "cloud coverage fraction",
        "matrix": "meteo",
        "standard_units": "unitless",
        "axis_label": "coverage (%)",
        "minimum_resolution": np.nan,
    ...
    "AOD_500nm_COARSE": {
        ...
        "aeronet_matrix": "oneill",
        "chemical_formula": "",
        "bsc_parameter_name": "od500aerocorse",
    },
    "AOD_500nm_FINE": {
...
def get_standard_metadata(parameter_details):
    standard_metadata = {
        ...
        "station_timezone": {
            ...
            "string_format": "short",
            "metadata_type": "STATION MISCELLANEOUS",
            "description": "Name of the local timezone that the measuring station is located in.",
        },
        "latitude": {
            "value": [],
        ...
        "administrative_country_division_1": {
            ...
            "string_format": "title_short",
            "metadata_type": "STATION MISCELLANEOUS",
            "description": "Name of the first (i.e. largest) country administrative division in which the station lies, e.g. countries within soverign state, state, province, county etc. These are defined for the purposes of managing of land and the affairs of people.",
        },
        "administrative_country_division_2": {
            ...
            "string_format": "title_short",
            "metadata_type": "STATION MISCELLANEOUS",
            "description": "Name of the second (i.e. second largest) country administrative division in which the station lies, e.g. countries within soverign state, state, province, county etc. These are defined for the purposes of managing of land and the affairs of people.",
        },
        "country": {
            "value": [],
