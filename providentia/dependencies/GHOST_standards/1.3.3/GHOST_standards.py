...
def get_standard_metadata(parameter_details):
    ...
    'network':                          {'value':[], 'standard_name':'network',                           'long_name':'data network',                                    'units':'unitless',                   'data_type':object,  'string_format':'short',        'metadata_type':np.nan,                       'description':'The name of the network which reports data for the specific station in question.'},
