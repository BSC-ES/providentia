...
def get_standard_data(parameter_details):
    standard_data = {
        ...
        "temporal_resolution": {
            ...
            "data_type": np.uint16,
            "string_format": np.nan,
            "description": "Temporal resolution that a specific measurement is representative of. Reported as an integer string (in minutes). If measured resolution is instantaneous, the given integer is 1.",
        },
        ...
        "season_code": {
            ...
            "data_type": np.uint8,
            "string_format": np.nan,
            "description": "Code decreeing if measurement was made during the Spring, Summer, Autumn or Winter Seasons. Spring=0, Summer=1, Autumn=2, Winter=3. The classification is made by evaluating which season the local-time of a mid-measurement window timestamp falls in.",
        },
        "flag": {
            "value": [],
            "standard_name": "flags",
            ...
            "data_type": object,
            "string_format": np.nan,
            "description": "List of associated data flag codes per measurement, indicating the data quality of a specific measurement, provided by the data reporter. Fill value code of 255.",
        },
        "qa": {
            "value": [],
            "standard_name": "qa",
            ...
            "data_type": object,
            "string_format": np.nan,
            "description": "List of derived quality assurance flag codes per measurement, informing on the quality associated with each observation, determined by multiple scientific quality control/assurance checks. Fill value code of 255.",
        },
    }
...
def get_standard_metadata(parameter_details):
    standard_metadata = {
        ...
        "area_classification": {
            "value": [],
            "standard_name": "area classification",
        ...
        "station_classification": {
            "value": [],
            "standard_name": "station classification",
        ...
        "main_emission_source": {
            "value": [],
            "standard_name": "main emission source",
        ...
        "measurement_scale": {
            "value": [],
            "standard_name": "measurement scale",
