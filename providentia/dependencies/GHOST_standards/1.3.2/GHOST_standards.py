...
'NCDC_ISD':         {'file_storage_type':'site_per_year',      'external_metadata_files':['isd-history.csv'],                                           'metadata_data_join_variable_name':'',          'data_level_hierarchy':{'fully-merged':3, 'partially-merged':2, 'non-merged':1}}, 
...
def get_standard_data(parameter_details):
    ...
    'flag':                                             {'value':[], 'standard_name':'flags',                                             'long_name':'data reporter provided standardised flags',         'units':'unitless',                          'data_type':object,  'string_format':np.nan, 'description':'List of associated data flags per measurement, indicating the data quality of a specific measurement, provided by the native data reporter.'},
...
def get_standard_metadata(parameter_details):
    ...
    'standardised_network_provided_area_classification':   {'value':[], 'standard_name':'standardised network provided area classification',    'long_name':'standardised network provided area classification',    'units':'unitless', 'data_type':object, 'string_format':'lower_short', 'metadata_type':'STATION CLASSIFICATIONS', 'description':'Standardised network provided classification, describing type of area a measurement station is situated in.'},                
    'standardised_network_provided_station_classification':{'value':[], 'standard_name':'standardised network provided station classification', 'long_name':'standardised network provided station classification', 'units':'unitless', 'data_type':object, 'string_format':'lower_short', 'metadata_type':'STATION CLASSIFICATIONS', 'description':'Standardised network provided classification, categorising the type of air measured by a station.'},                
    'standardised_network_provided_main_emission_source':  {'value':[], 'standard_name':'standardised network provided main emission source',   'long_name':'standardised network provided main emission source',   'units':'unitless', 'data_type':object, 'string_format':'lower_short', 'metadata_type':'STATION CLASSIFICATIONS', 'description':'Standardised network provided classification, describing the main emission source influencing air measured at a station.'},                
    'standardised_network_provided_land_use':              {'value':[], 'standard_name':'standardised network provided land use',               'long_name':'standardised network provided land use type',          'units':'unitless', 'data_type':object, 'string_format':'lower_short', 'metadata_type':'STATION CLASSIFICATIONS', 'description':'Standardised network provided classification, describing the dominant land use in the area of the reporting station.'},                
    'standardised_network_provided_terrain':               {'value':[], 'standard_name':'standardised network provided terrain',                'long_name':'standardised network provided terrain type',           'units':'unitless', 'data_type':object, 'string_format':'lower_short', 'metadata_type':'STATION CLASSIFICATIONS', 'description':'Standardised network provided classification, describing the dominant terrain in the area of the reporting station.'},                 
    'standardised_network_provided_measurement_scale':     {'value':[], 'standard_name':'standardised network provided measurement scale',      'long_name':'standardised network provided measurement scale',      'units':'unitless', 'data_type':object, 'string_format':'lower_short', 'metadata_type':'STATION CLASSIFICATIONS', 'description':'Standardised network provided classification, a denotation of the geographic scope of the air quality measurements made.'},                         
