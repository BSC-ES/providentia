...
def get_standard_metadata(parameter_details):
    ...
    'MODIS_MCD12C1_v6_UMD_land_use':                    {'value':[], 'standard_name':'MODIS MCD12C1 v6 UMD land use',                     'long_name':'MODIS MCD12C1 v6 UMD land use',                               'units':'unitless', 'data_type':object,  'string_format':'lower_short', 'metadata_type':'GLOBALLY GRIDDED CLASSIFICATIONS', 'description':'Land use from the Moderate Resolution Imaging Spectroradiometer (MODIS) Land Cover Climate Modeling Grid (CMG) MCD12C1 version 6, using the University of Maryland (UMD) classification. Native resolution of 0.05 x 0.05 degrees. See dataset user guide here: https://lpdaac.usgs.gov/documents/101/MCD12_User_Guide_V6.pd'},
    ...
    'MODIS_MCD12C1_v6_LAI':                             {'value':[], 'standard_name':'MODIS MCD12C1 v6 LAI',                              'long_name':'MODIS MCD12C1 v6 Leaf Area Index',                            'units':'unitless', 'data_type':object,  'string_format':'lower_short', 'metadata_type':'GLOBALLY GRIDDED CLASSIFICATIONS', 'description':'Leaf Area Index from the Moderate Resolution Imaging Spectroradiometer (MODIS) Land Cover Climate Modeling Grid (CMG) MCD12C1 version 6. Native resolution of 0.05 x 0.05 degrees. See dataset user guide here: https://lpdaac.usgs.gov/documents/101/MCD12_User_Guide_V6.pd'},
