...
standard_parameters = {
    ...
    "CH4": {
        ...
        "extreme_upper_monthly_median": 5000.0,
        "aqs_code": "",
    ...
    "SO2": {
        ...
        "extreme_lower_limit": 0.0,
        "extreme_upper_limit": 5000.0,
        "extreme_upper_monthly_median": 300.0,
        "aqs_code": "",
    ...
    "PAN": {
        ...
        "extreme_upper_monthly_median": 20.0,
        "aqs_code": "",
...
def get_standard_metadata(parameter_details):
    standard_metadata = {
        ...
        "latitude": {
            ...
            "description": "Geodetic latitude of measuring instrument, in decimal degrees North.",
        },
        "longitude": {
            "value": [],
            ...
            "string_format": np.nan,
            "metadata_type": "STATION POSITION",
            "description": "Geodetic longitude of measuring instrument, in decimal degrees East.",
        },
        "altitude": {
            "value": [],
            ...
            "string_format": np.nan,
            "metadata_type": "STATION POSITION",
            "description": "Altitude of the ground level at the station, relative to the mean sea level datum, in metres.",
        },
        "sampling_height": {
            "value": [],
        ...
        "measurement_altitude": {
            ...
            "string_format": np.nan,
            "metadata_type": "STATION POSITION",
            "description": "Altitude of the inlet/instrument/sampler, relative to the mean sea level datum, in metres.",
        },
...
standard_measurement_methodologies = {
    ...
    "sulphur chemiluminescence - gas chromatography": {
        "abbreviation": "SC-GC",
        "sampling_type": "low volume continuous",
    ...
    "flame ionisation detection": {
        ...
        "measured_parameters": ["C2H6", "CH4", "ISOPRENE"],
    ...
    "selective combustion - flame ionisation detection": {
        ...
        "sampling_type": "low volume vontinuous",
        "measured_parameters": ["C2H6", "CH4", "ISOPRENE"],
        "qa_accepted_parameters": ["C2H6", "CH4", "ISOPRENE"],
        "instruments": {
            "Horiba APHA350": {
                "measured_parameters": ["CH4"],
                "qa_accepted_parameters": ["CH4"],
    ...
    "second derivative spectroscopy": {
        ...
        "instruments": {
            "Ecotech SM1000": {
                "measured_parameters": ["SO2"],
                "qa_accepted_parameters": [],
                "instrument_further_details": "No manual or specifications available but confirmation it is uses second derivative spectroscopy here:https://books.google.es/books?id=yCDGFlP3toUC&pg=PA249&lpg=PA249&dq=monitor+labs+8450&source=bl&ots=-uIdNzc1_l&sig=LqRK0OiodCMg5Sow1wlXQgIVLx0&hl=en&sa=X&ved=0ahUKEwjCy8eNvOfbAhVBuhQKHZTJBUoQ6AEIWDAG#v=onepage&q=monitor%20labs%208450&f=false",
            }
        },
    },
    # ------------------------------------
    ...
    "differential optical absorption spectroscopy": {
        ...
        "measured_parameters": ["CO", "NO", "NO2", "NOx", "O3", "SO2", "NH3", "C6H6"],
        "qa_accepted_parameters": [
            "CO",
            "NO",
            "NO2",
    ...
    "gas chromatography - electron capture detection": {
        "abbreviation": "GC-ECD",
        "sampling_type": "injection",
        "measured_parameters": ["CH4", "C6H6", "ISOPRENE", "PAN"],
        "qa_accepted_parameters": ["CH4", "C6H6", "ISOPRENE", "PAN"],
        "instruments": {},
    },
    # ------------------------------------
    ...
    "gas chromatography - flame ionisation detection": {
        "abbreviation": "GC-FID",
        "sampling_type": "injection",
        "measured_parameters": ["CH4", "C6H6", "ISOPRENE"],
        "qa_accepted_parameters": ["CH4", "C6H6", "ISOPRENE"],
        "instruments": {},
    },
    # ------------------------------------
