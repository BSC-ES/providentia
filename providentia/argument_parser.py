...
class ProvArgumentParser(object):
    ...
    def __init__(self):
        ...
        try:
            ...
            self.parser.add_argument(
                "--clean", action="store_true", help="cleans all output files"
            )
            self.parser.add_argument(
                "--section", dest="section", help="config file section to read"
            )
            self.parser.add_argument(
                "--ghost_version",
                dest="ghost_version",
            ...
            self.parser.add_argument(
                "--mod_root", dest="mod_root", help="set model root data directory"
            )
            self.parser.add_argument(
                "--mod_to_interp_root",
            ...
            self.parser.add_argument(
                ...
                help="define model resolution if it is different from the observation one",
            )
            self.parser.add_argument(
                "--start_date",
                dest="start_date",
            ...
            self.parser.add_argument(
                "--experiments", dest="experiments", help="models to read"
            )
            self.parser.add_argument(
                "--experiment", dest="experiment", help="models to read"
            )
            self.parser.add_argument("--model", dest="model", help="models to read")
            self.parser.add_argument("--models", dest="models", help="models to read")
            self.parser.add_argument(
                "--domain", dest="domain", help="domain of the model"
            )
            self.parser.add_argument(
                "--ensemble",
                dest="ensemble",
            ...
            self.parser.add_argument(
                "--forecast", dest="forecast", help="set part of forecast data desired"
            )
            self.parser.add_argument(
                "--qa",
                dest="qa",
            ...
            self.parser.add_argument(
                "--report_title", dest="report_title", help="report title"
            )
            self.parser.add_argument(
                "--report_filename", dest="report_filename", help="report filename"
            )
            self.parser.add_argument(
                "--harmonise_summary",
            ...
            self.parser.add_argument(
                "--dl_timeout", dest="dl_timeout", help="download timeout seconds"
            )
            self.parser.add_argument(
                "--dl_thredds_update",
